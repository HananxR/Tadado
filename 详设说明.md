...
- 信号：`select_all_requested` / `deselect_all_requested` / `batch_status_change` / `batch_delete` / `batch_suspend` / `batch_restart` / `batch_postpone`(list, int) / `export_requested`(str)
