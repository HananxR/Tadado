...
| ② | **速览栏** | 标题栏下方 | 昨天 / 今天 / 上周 / 本周 / 上月 / 本月 6 个预设按钮，点击按**创建时间**过滤任务（排除已完成已归档），右侧自动轮播最近任务卡片。定位：快速查看"某个时间窗口内还有哪些事没做完" |
...
| **设置对话框** | 标题栏「设置」按钮 | 单页滚动，6 个区块：🎨 外观（亮色/暗色主题、最小化到托盘）/ 📋 任务列表（每页条数、默认排序、已完成任务排在末尾）/ 🔔 提醒（启用开关、间隔分钟、安静时段）/ 🔒 分区管理（7 列表格：名称/默认/可见/归档阈值/自动锁定/密码）/ 💬 激励语（4 条自定义语录） |
...
| ☁️ [阿里云盘](https://www.alipan.com/s/E2FBppaMPZj) | 仅提供安装版 |
